...
// Text Colors Amount and Background Colors Amount
var TextColorsAmount = 14;
var BgColorsAmount = 25;
...
function initArrays() {
	...
	maskArray = new Array(TextColorsAmount);
	for (var i = 1; i <= maskArray.length; i++) {
		maskArray[i-1] = i + '.png';
	}
	// Amount of images
	bgArray = new Array(BgColorsAmount);
